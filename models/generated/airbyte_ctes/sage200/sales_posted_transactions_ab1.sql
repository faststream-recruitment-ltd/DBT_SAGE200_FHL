...
-- depends_on: {{ source('sage200_etl_fhl', '_airbyte_raw_sales_posted_transactions') }}
select
...
from {{ source('sage200_etl_fhl', '_airbyte_raw_sales_posted_transactions') }} as table_alias
