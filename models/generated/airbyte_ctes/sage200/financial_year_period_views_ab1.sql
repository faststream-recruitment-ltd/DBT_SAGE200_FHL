...
-- depends_on: {{ source('sage200_etl_fhl', '_airbyte_raw_financial_year_period_views') }}
select
...
from {{ source('sage200_etl_fhl', '_airbyte_raw_financial_year_period_views') }} as table_alias
